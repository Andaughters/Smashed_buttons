...
export function Header() {
  ...
  return (
    <header className={cn(
      ...
      isScrolled ? "bg-background/80 backdrop-blur-md py-2 border-b border-border" : "py-4"
    )}>
      <div className="container flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center">
            <SupabaseLogo className="h-8 w-auto" />
          </Link>
        ...
        <div className="flex items-center gap-4">
          <Link
            ...
            className="hidden md:flex items-center gap-1 text-sm text-foreground/80 hover:text-foreground transition-colors"
          >
          ...
          <Link href="/dashboard" className="hidden md:inline-block">
            <Button variant="default" size="sm">Start your project</Button>
          </Link>
...
function DesktopNav() {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="bg-transparent">Enterprise</NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid w-[400px] gap-3 p-4">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  <a
                    className="flex h-full w-full flex-col justify-between rounded-md bg-secondary/50 p-6 no-underline outline-none focus:shadow-md"
                    href="/enterprise"
                  >
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      For large-scale applications managing critical workloads.
                    </p>
                  </a>
                </NavigationMenuLink>
              </li>
    ...
    <Sheet>
      ...
      <SheetContent className="w-full">
        <div className="flex flex-col gap-6 mt-6">
          <Link href="/enterprise" className="flex items-center py-2 text-lg font-medium">
            Enterprise
          </Link>
          <Link href="/pricing" className="flex items-center py-2 text-lg font-medium">
            Pricing
          </Link>
          <Link href="/docs" className="flex items-center py-2 text-lg font-medium">
            Docs
          </Link>
          <Link href="/blog" className="flex items-center py-2 text-lg font-medium">
            Blog
          </Link>
